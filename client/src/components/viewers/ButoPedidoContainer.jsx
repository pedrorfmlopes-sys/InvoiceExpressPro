...
import ButoPedidoViewer from './ButoPedidoViewer';
import api from '../../api/apiClient';

export default function ButoPedidoContainer({ doc, onClose, updateRow, onFinalize, mode = 'staging' }) {
    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                ...
                console.error('[ButoPedidoContainer] Load Failed:', err);
            } finally {

...
import ScarabeoInvoiceViewer from './ScarabeoInvoiceViewer';
import api from '../../api/apiClient';

/**
 * ScarabeoInvoiceContainer
 * Manages loading, saving, and PDF synchronization for Scarabeo Invoices.
 */
export default function ScarabeoInvoiceContainer({ doc, onClose, updateRow, onFinalize, mode = 'staging' }) {
    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                ...
                console.error("[ScarabeoInvoiceContainer] Load Failed:", err);
    ...
    const handleReconcile = async () => {
        try {
            // Reusing the exact same service as Nicolazzi!

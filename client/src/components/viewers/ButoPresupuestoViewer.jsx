...
// BUTÖ PRESUPUESTO VIEWER — Tema Indigo/Azul | Nicolazzi-style layout
export default function ButoPresupuestoViewer({
    ...
    const hasTransport = parseFloat(sd.totals?.transport || 0) > 0;

...
import ButoPresupuestoViewer from './ButoPresupuestoViewer';
import api from '../../api/apiClient';

export default function ButoPresupuestoContainer({ doc, onClose, updateRow, onFinalize, mode = 'staging' }) {
    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                ...
                console.error('[ButoPresupuestoContainer] Load Failed:', err);
            } finally {

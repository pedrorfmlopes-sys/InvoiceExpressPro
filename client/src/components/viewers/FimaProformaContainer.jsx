...
import FimaProformaViewer from './FimaProformaViewer';
import api from '../../api/apiClient';

/**
 * FimaProformaContainer
 * Manages loading, saving, and PDF sync for FIMA Proformas.
 */
export default function FimaProformaContainer({ doc, onClose, updateRow, onFinalize, mode = 'staging' }) {
    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                ...
                console.error('[FimaProformaContainer] Load Failed:', err);

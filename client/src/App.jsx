...
import ProjectsTab from './tabs/ProjectsTab' // New Dossiers Module
...
export default function App() {
  ...
  const TABS = [
    ...
    { id: 'labels', label: 'Gestão de Etiquetas', Component: LabelsManagerTab },
    { id: 'extraction', label: 'Perfis de Leitura', Component: ExtractionProfilesTab },
    { id: 'assets', label: 'Imagens & Ícones', Component: AssetsTab },
